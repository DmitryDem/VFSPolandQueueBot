...
WAVE_GROUPS = [
    # якорь 07.09: после сдвига волны на пт 28.08 ритм пошёл 07.09 → 21.09 → 05.10 (старый якорь 17.08 давал 14.09/28.09)
    ("Минск, Гомель, Могилёв, Витебск", ["Минск", "Гомель", "Могилев", "Витебск"], 0, 14, date(2026, 9, 7)),
