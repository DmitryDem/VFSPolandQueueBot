...
VISA_LABELS = {
    ...
    "D_STUDENT": "Национальная D (Student)",
...
BUTTON_MESSAGES: dict[tuple[str, str], int] = {
    ...
    # новые категории (D Student — правка на месте; D Карта — свежие посты 21.08)
    ("Гомель", "D_STUDENT"): 1424, ("Минск", "D_STUDENT"): 1429,
    ("Могилев", "D_STUDENT"): 3224, ("Витебск", "D_STUDENT"): 1434,
    ("Гродно", "D_KARTA"): 3725, ("Лида", "D_KARTA"): 3727,
}
...
def build(city: str, visa: str):
    ...
    text = (
        ...
        "📜 <b>Очередь по постановке</b> — все анкеты этой темы по порядку, "
        "видно ваше место относительно других."
    )
    kb = {
        "inline_keyboard": [
            ...
            [{"text": "📜 Очередь по постановке",
              "url": f"https://t.me/{BOT_USERNAME}?start=q_{idx}_{visa}"}],
        ]
    }
    return text, kb
